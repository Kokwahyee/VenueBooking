...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="#">Venues</a>
                <ul class="dropdown">
                    <li><a href="{{ route('venue') }}">Venue List</a></li>
                    <li><a href="{{ route('venue.manage') }}">Venue Management</a></li>
                </ul></li>
    ...
    <div class="login-register">
        ...
        <div class="profile">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-responsive-nav-link class="btn-login" href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">
                    {{ __('Profile') }}
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <x-responsive-nav-link class="btn-login" href="{{ route('logout') }}"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('venue.manage')" :active="request()->routeIs('venue_manage')">
                                {{ __('Venue Management.') }}
                            </x-dropdown-link>
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('booking.index') }}" :active="request()->routeIs('bookings')">
                        {{ __('Bookings') }}
                    </x-nav-link>
                </div>
