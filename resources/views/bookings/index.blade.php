                ...
                <table class="table-auto w-full border-collapse border border-black">
                    <thead>
                        <tr class="bg-gray-200">
                            ...
                            <th class="border-2 border-black px-4 py-2 text-left font-semibold">Actions</th> <!-- Added Actions column -->
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            @foreach ($bookings as $booking)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border-2 border-black px-4 py-2">
                                        <a href="" class="text-blue-500 hover:text-blue-700 mr-2 px-2 py-1 rounded-md bg-blue-100 hover:bg-blue-200 transition-colors duration-300">View</a>
                                        ...
                                        <a href="" class="text-purple-500 hover:text-purple-700 px-2 py-1 rounded-md bg-purple-100 hover:bg-purple-200 transition-colors duration-300">Request for Change</a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
                                <td colspan="5" class="border-2 border-black px-4 py-2">No bookings found</td>
                            </tr>
                        @endunless
                    </tbody>
                </table>
