<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700 shadow-sm">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="left" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-300 hover:text-white focus:outline-none focus:text-white transition duration-150 ease-in-out">
                                <span>{{ __('Venue') }}</span>
                                <svg class="h-4 w-4 ml-1 text-gray-300 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('venue')" :active="request()->routeIs('venue')" class="text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                                {{ __('Venue List') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('venue.manage')" :active="request()->routeIs('venue.manage')" class="text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                                {{ __('Venue Management') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    <div class="ml-3 relative">
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 bg-gray-800 hover:text-white focus:outline-none focus:bg-gray-700 transition ease-in-out duration-150">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <x-dropdown-link href="{{ route('logout') }}" @click.prevent="$root.submit();" class="text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                                    {{ __('Log Out') }}
                                </x-dropdown-link>
                            </form>
                        </x-slot>
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    @foreach (Auth::user()->allTeams() as $team)
                        <x-switchable-team :team="$team" component="responsive-nav-link" class="text-gray-300 hover:text-white" />
                    @endforeach
                @endif
            </div>
        </div>
